...
// No try-catch needed anywhere in the codebase
@Slf4j
@RestControllerAdvice
public class GlobalExceptionHandler {

    // Handles @Valid annotation failures (blank fields, bad email, etc.)
    ...
    // Handles entity not found (user, question, quiz)
    ...
    // Catch-all — logs the full stack trace, returns generic 500
